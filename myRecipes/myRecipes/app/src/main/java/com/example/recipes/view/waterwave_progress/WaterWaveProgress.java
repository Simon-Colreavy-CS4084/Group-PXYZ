package com.example.recipes.view.waterwave_progress;
...
public class WaterWaveProgress extends View {
    ...
    private String showText = "";
          ...
          private boolean mShowProgress = false, mShowNumerical = false;
    ...
    private float mWaveSpeed = 0.070F;          
    private int mWaterAlpha = 255;       WaterWaveAttrInit attrInit;
    ...
    private void init(Context context) {
        ...
        mRingPaint.setColor(mRingColor);           mRingPaint.setStyle(Paint.Style.STROKE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowNumerical) {
            if (TextUtils.isEmpty(showText)) {
                ...
                float mTxtWidth = mTextPaint.measureText(showText, 0,
                        showText.length());
                Paint.FontMetrics fontMetrics = mTextPaint.getFontMetrics();
                float top = fontMetrics.top;                  float bottom = fontMetrics.bottom;                  int baseLineY = (int) (oval.centerY() - top/2 - bottom/2);  
                canvas.drawText(showText, mCenterPoint.x - mTxtWidth / 2,
    ...
    public void setProgressToShowText(int progress) {
        progress = progress > 100 ? 100 : progress < 0 ? 0 : progress;
        mProgress = progress;
        showText = progress + " min";
        invalidate();
    }
