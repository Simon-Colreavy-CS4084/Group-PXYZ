...
import com.example.recipes.ui.newsfeed.NewsFeedSearchResultActivity;
...
public class RecipcSearchActivity extends AppCompatActivity {
    private EditText mSearchView;
          private FlowsLayout mHotView;
          private FlowsLayout mHistoryView;

          private String[] hotVals = new String[]{"steak", "salad", "breakfast"};

    private final String KEY_HISTORY = "key_recipc_historys";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipc_search);
    ...
    private void initClick() {
        ...
        findViewById(R.id.tv_clear).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                                  resetHistory(null);
                Toast.makeText(RecipcSearchActivity.this, "History cleared successfully", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void insertData(String data) {
        mSearchView.setText(data);
            ...
            resetHistory(set);
                  ...
                  if (!TextUtils.isEmpty(data)) {
            Intent intent = new Intent(RecipcSearchActivity.this, RecipcSearchResultActivity.class);
