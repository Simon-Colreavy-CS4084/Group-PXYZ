...
import cn.bmob.v3.listener.UpdateListener;
  ...
  public class NewsFeedDetailsActivity extends AppCompatActivity {
                    ...
                    comment.save(new SaveListener<String>() {
                        ...
                        public void done(String objectId, BmobException e) {
                            if (e == null) {
                                ...
                                Toast.makeText(NewsFeedDetailsActivity.this, "失败：" + e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
    ...
    private View getHeaderView() {
        ...
        String image = "http:          if (newsFeedData.getAuthor().getImage() != null && !TextUtils.isEmpty(newsFeedData.getAuthor().getImage().getUrl())) {
