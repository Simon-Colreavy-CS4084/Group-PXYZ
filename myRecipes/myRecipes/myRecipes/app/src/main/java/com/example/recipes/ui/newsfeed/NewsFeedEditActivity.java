        ...
        if (newsFeedData != null) {
            ...
            newsFeedData.update(new UpdateListener() {
                ...
                public void done(BmobException e) {
                    if (e == null) {
                        Toast.makeText(NewsFeedEditActivity.this, "更新成功",
                                Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(NewsFeedEditActivity.this, "失败：" + e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
            });
        } else {
            ...
            newsFeedData.save(new SaveListener<String>() {
                ...
                public void done(String objectId, BmobException e) {
                    if (e == null) {
                        Toast.makeText(NewsFeedEditActivity.this, "添加成功",
                                Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(NewsFeedEditActivity.this, "失败：" + e.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void uploadFiles() {
        ...
        BmobFile.uploadBatch(filePaths, new UploadBatchListener() {
            ...
            public void onError(int statuscode, String errormsg) {
                ...
                Log.e("asd", errormsg);
                Toast.makeText(NewsFeedEditActivity.this, "错误码" + statuscode + ",错误描述：" + errormsg, Toast.LENGTH_LONG).show();
            }
