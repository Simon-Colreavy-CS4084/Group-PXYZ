...
public class WaterWaveAttrInit {
	...
	private int progressWidth;    	private int progressColor;
	private int progressBgColor;
	private int waterWaveColor;
	private int waterWaveBgColor;
	private int progress2WaterWidth;    	private boolean showProgress;    	private boolean showNumerical;    	private int fontSize;
