...
import cn.jzvd.JzvdStd;
  ...
  public class RecipcDetailActivity extends AppCompatActivity implements HeadZoomScrollView.OnScrollChangedListener {
    ...
    public void onScrollChanged(ScrollView who, int l, int t, int oldl, int oldt) {
        ...
        String images = "http:          if (!TextUtils.isEmpty(recipcData.getImg())) {
        ...
        String image = "http:          if (recipcData.getAuthor().getImage() != null && !TextUtils.isEmpty(recipcData.getAuthor().getImage().getUrl())) {
                    ...
                    comment.save(new SaveListener<String>() {
                        ...
                        public void done(String objectId, BmobException e) {
                            if (e == null) {
                                ...
                                Toast.makeText(RecipcDetailActivity.this, "失败：" + e.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
